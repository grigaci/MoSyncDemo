#ifndef IX_WIDGET_DEFS_H
#define IX_WIDGET_DEFS_H
...
#ifndef DONT_WANT_IX_WIDGET_TYPEDEFS
/** @ingroup WidgetAPI */
...
#pragma pack(pop)
#endif
typedef struct MAWidgetEventDataNative {
	/**
	* @brief Determines which kind of widget event that has occurred. See \ref WidgetEventTypes "Widget event types" for the possible values.
	*/
	int eventType;
...
#pragma pack(pop)
#endif
typedef struct MA_ACTION_BAR_ITEM_ICONNative {
	int iconPredefinedId;
	MAHandle iconHandle;
} MA_ACTION_BAR_ITEM_ICONNative;

#define maExtensionFunctionInvoke_IX_WIDGET_caselist \

#define maExtensionFunctionInvoke_IX_WIDGET_syscall_caselist \
...
#define maIOCtl_IX_WIDGET_caselist \
maIOCtl_maWidgetCreate_case(maWidgetCreate) \
maIOCtl_maWidgetDestroy_case(maWidgetDestroy) \
maIOCtl_maWidgetAddChild_case(maWidgetAddChild) \
maIOCtl_maWidgetInsertChild_case(maWidgetInsertChild) \
maIOCtl_maWidgetRemoveChild_case(maWidgetRemoveChild) \
maIOCtl_maWidgetModalDialogShow_case(maWidgetModalDialogShow) \
maIOCtl_maWidgetModalDialogHide_case(maWidgetModalDialogHide) \
maIOCtl_maWidgetScreenShow_case(maWidgetScreenShow) \
maIOCtl_maWidgetScreenShowWithTransition_case(maWidgetScreenShowWithTransition) \
maIOCtl_maWidgetStackScreenPush_case(maWidgetStackScreenPush) \
maIOCtl_maWidgetStackScreenPop_case(maWidgetStackScreenPop) \
maIOCtl_maWidgetSetProperty_case(maWidgetSetProperty) \
maIOCtl_maWidgetGetProperty_case(maWidgetGetProperty) \
maIOCtl_maWidgetScreenAddOptionsMenuItem_case(maWidgetScreenAddOptionsMenuItem) \
maIOCtl_maActionBarSetEnabled_case(maActionBarSetEnabled) \
maIOCtl_maActionBarAddMenuItem_case(maActionBarAddMenuItem) \
maIOCtl_maActionBarRemoveMenuItem_case(maActionBarRemoveMenuItem) \
maIOCtl_maActionBarRefresh_case(maActionBarRefresh) \
maIOCtl_maActionBarSetVisibility_case(maActionBarSetVisibility) \
maIOCtl_maActionBarGetHeight_case(maActionBarGetHeight) \
maIOCtl_maActionBarIsShowing_case(maActionBarIsShowing) \
maIOCtl_maActionBarSetTitle_case(maActionBarSetTitle) \
maIOCtl_maActionBarSetIcon_case(maActionBarSetIcon) \
maIOCtl_maActionBarShowTitleEnabled_case(maActionBarShowTitleEnabled) \
maIOCtl_maActionBarShowLogoEnabled_case(maActionBarShowLogoEnabled) \
maIOCtl_maActionBarSetHomeButtonEnabled_case(maActionBarSetHomeButtonEnabled) \
maIOCtl_maActionBarSetDisplayHomeAsUpEnabled_case(maActionBarSetDisplayHomeAsUpEnabled) \
maIOCtl_maActionBarSetBackgroundImage_case(maActionBarSetBackgroundImage) \

#define maIOCtl_IX_WIDGET_syscall_caselist \
maIOCtl_syscall_case(maWidgetCreate) \
maIOCtl_syscall_case(maWidgetDestroy) \
maIOCtl_syscall_case(maWidgetAddChild) \
maIOCtl_syscall_case(maWidgetInsertChild) \
maIOCtl_syscall_case(maWidgetRemoveChild) \
maIOCtl_syscall_case(maWidgetModalDialogShow) \
maIOCtl_syscall_case(maWidgetModalDialogHide) \
maIOCtl_syscall_case(maWidgetScreenShow) \
maIOCtl_syscall_case(maWidgetScreenShowWithTransition) \
maIOCtl_syscall_case(maWidgetStackScreenPush) \
maIOCtl_syscall_case(maWidgetStackScreenPop) \
maIOCtl_syscall_case(maWidgetSetProperty) \
maIOCtl_syscall_case(maWidgetGetProperty) \
maIOCtl_syscall_case(maWidgetScreenAddOptionsMenuItem) \
maIOCtl_syscall_case(maActionBarSetEnabled) \
maIOCtl_syscall_case(maActionBarAddMenuItem) \
maIOCtl_syscall_case(maActionBarRemoveMenuItem) \
maIOCtl_syscall_case(maActionBarRefresh) \
maIOCtl_syscall_case(maActionBarSetVisibility) \
maIOCtl_syscall_case(maActionBarGetHeight) \
maIOCtl_syscall_case(maActionBarIsShowing) \
maIOCtl_syscall_case(maActionBarSetTitle) \
maIOCtl_syscall_case(maActionBarSetIcon) \
maIOCtl_syscall_case(maActionBarShowTitleEnabled) \
maIOCtl_syscall_case(maActionBarShowLogoEnabled) \
maIOCtl_syscall_case(maActionBarSetHomeButtonEnabled) \
maIOCtl_syscall_case(maActionBarSetDisplayHomeAsUpEnabled) \
maIOCtl_syscall_case(maActionBarSetBackgroundImage) \
...
#undef ARG_NO_10
#define ARG_NO_10 SYSCALL_THIS->GetValidatedStackValue(24 VSV_ARGPTR_USE)
#define maIOCtl_maWidgetCreate 116
#define maIOCtl_maWidgetCreate_case(func) \
case 116: \
{ \
const char* _widgetType = GVS(a); \
return func(_widgetType); \
} \

#define maIOCtl_maWidgetDestroy 117
#define maIOCtl_maWidgetDestroy_case(func) \
case 117: \
{ \
MAWidgetHandle _widget = (MAWidgetHandle)a; \
return func(_widget); \
} \

#define maIOCtl_maWidgetAddChild 118
#define maIOCtl_maWidgetAddChild_case(func) \
case 118: \
{ \
MAWidgetHandle _parent = (MAWidgetHandle)a; \
MAWidgetHandle _child = (MAWidgetHandle)b; \
return func(_parent, _child); \
} \

#define maIOCtl_maWidgetInsertChild 119
#define maIOCtl_maWidgetInsertChild_case(func) \
case 119: \
{ \
MAWidgetHandle _parent = (MAWidgetHandle)a; \
MAWidgetHandle _child = (MAWidgetHandle)b; \
int _index = c; \
return func(_parent, _child, _index); \
} \

#define maIOCtl_maWidgetRemoveChild 120
#define maIOCtl_maWidgetRemoveChild_case(func) \
case 120: \
{ \
MAWidgetHandle _child = (MAWidgetHandle)a; \
return func(_child); \
} \

#define maIOCtl_maWidgetModalDialogShow 121
#define maIOCtl_maWidgetModalDialogShow_case(func) \
case 121: \
{ \
MAWidgetHandle _dialogHandle = (MAWidgetHandle)a; \
return func(_dialogHandle); \
} \

#define maIOCtl_maWidgetModalDialogHide 122
#define maIOCtl_maWidgetModalDialogHide_case(func) \
case 122: \
{ \
MAWidgetHandle _dialogHandle = (MAWidgetHandle)a; \
return func(_dialogHandle); \
...
#define maIOCtl_maWidgetScreenShow 123
#define maIOCtl_maWidgetScreenShow_case(func) \
case 123: \
{ \
MAWidgetHandle _screenHandle = (MAWidgetHandle)a; \
return func(_screenHandle); \
} \

#define maIOCtl_maWidgetScreenShowWithTransition 124
#define maIOCtl_maWidgetScreenShowWithTransition_case(func) \
case 124: \
{ \
MAWidgetHandle _screenHandle = (MAWidgetHandle)a; \
MAWScreenTransitionType _screenTransitionType = (MAWScreenTransitionType)b; \
int _screenTransitionDuration = c; \
return func(_screenHandle, _screenTransitionType, _screenTransitionDuration); \
} \

#define maIOCtl_maWidgetStackScreenPush 125
#define maIOCtl_maWidgetStackScreenPush_case(func) \
case 125: \
{ \
MAWidgetHandle _stackScreen = (MAWidgetHandle)a; \
MAWidgetHandle _newScreen = (MAWidgetHandle)b; \
return func(_stackScreen, _newScreen); \
} \

#define maIOCtl_maWidgetStackScreenPop 126
#define maIOCtl_maWidgetStackScreenPop_case(func) \
case 126: \
{ \
MAWidgetHandle _stackScreen = (MAWidgetHandle)a; \
return func(_stackScreen); \
} \

#define maIOCtl_maWidgetSetProperty 127
#define maIOCtl_maWidgetSetProperty_case(func) \
case 127: \
{ \
MAWidgetHandle _widget = (MAWidgetHandle)a; \
const char* _property = GVS(b); \
const char* _value = GVS(c); \
return func(_widget, _property, _value); \
} \

#define maIOCtl_maWidgetGetProperty 128
#define maIOCtl_maWidgetGetProperty_case(func) \
case 128: \
{ \
MAWidgetHandle _widget = (MAWidgetHandle)a; \
const char* _property = GVS(b); \
...
return func(_widget, _property, _value, _bufSize); \
} \

#define maIOCtl_maWidgetScreenAddOptionsMenuItem 129
#define maIOCtl_maWidgetScreenAddOptionsMenuItem_case(func) \
case 129: \
{ \
MAWidgetHandle _widget = (MAWidgetHandle)a; \
const char* _title = GVS(b); \
const char* _iconPath = GVS(c); \
int _iconPredefined = ARG_NO_4; \
return func(_widget, _title, _iconPath, _iconPredefined); \
} \

#define maIOCtl_maActionBarSetEnabled 130
#define maIOCtl_maActionBarSetEnabled_case(func) \
case 130: \
{ \
int _showActionBar = a; \
return func(_showActionBar); \
} \

#define maIOCtl_maActionBarAddMenuItem 131
#define maIOCtl_maActionBarAddMenuItem_case(func) \
case 131: \
{ \
MAHandle _screenHandle = (MAHandle)a; \
const char* _title = GVS(b); \
const MA_ACTION_BAR_ITEM_ICON* _item = GVMR(c, MA_ACTION_BAR_ITEM_ICON); \
int _displayFlag = ARG_NO_4; \
return func(_screenHandle, _title, _item, _displayFlag); \
} \

#define maIOCtl_maActionBarRemoveMenuItem 132
#define maIOCtl_maActionBarRemoveMenuItem_case(func) \
case 132: \
{ \
MAHandle _screenHandle = (MAHandle)a; \
int _itemHandle = b; \
return func(_screenHandle, _itemHandle); \
} \

#define maIOCtl_maActionBarRefresh 133
#define maIOCtl_maActionBarRefresh_case(func) \
case 133: \
{ \
return func(); \
} \

#define maIOCtl_maActionBarSetVisibility 134
#define maIOCtl_maActionBarSetVisibility_case(func) \
case 134: \
{ \
int _showState = a; \
return func(_showState); \
} \

#define maIOCtl_maActionBarGetHeight 135
#define maIOCtl_maActionBarGetHeight_case(func) \
case 135: \
{ \
return func(); \
} \

#define maIOCtl_maActionBarIsShowing 136
#define maIOCtl_maActionBarIsShowing_case(func) \
case 136: \
{ \
return func(); \
} \

#define maIOCtl_maActionBarSetTitle 137
#define maIOCtl_maActionBarSetTitle_case(func) \
case 137: \
{ \
...
#define maIOCtl_maActionBarSetIcon 138
#define maIOCtl_maActionBarSetIcon_case(func) \
case 138: \
{ \
MAHandle _iconHandle = (MAHandle)a; \
return func(_iconHandle); \
} \

#define maIOCtl_maActionBarShowTitleEnabled 139
#define maIOCtl_maActionBarShowTitleEnabled_case(func) \
case 139: \
{ \
int _enableTitle = a; \
return func(_enableTitle); \
} \

#define maIOCtl_maActionBarShowLogoEnabled 140
#define maIOCtl_maActionBarShowLogoEnabled_case(func) \
case 140: \
{ \
int _enableLogo = a; \
return func(_enableLogo); \
} \

#define maIOCtl_maActionBarSetHomeButtonEnabled 141
#define maIOCtl_maActionBarSetHomeButtonEnabled_case(func) \
case 141: \
{ \
int _state = a; \
return func(_state); \
...
#define maIOCtl_maActionBarSetDisplayHomeAsUpEnabled 142
#define maIOCtl_maActionBarSetDisplayHomeAsUpEnabled_case(func) \
case 142: \
{ \
int _showHomeAsUp = a; \
return func(_showHomeAsUp); \
} \

#define maIOCtl_maActionBarSetBackgroundImage 143
#define maIOCtl_maActionBarSetBackgroundImage_case(func) \
case 143: \
{ \
MAHandle _imageHandle = (MAHandle)a; \
return func(_imageHandle); \
} \


#endif	//IX_WIDGET_DEFS_H
