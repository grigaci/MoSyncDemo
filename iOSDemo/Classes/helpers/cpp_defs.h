...
maIOCtl_maExtensionFunctionInvoke2_case(maExtensionFunctionInvoke2) \
...
maIOCtl_syscall_case(maExtensionFunctionInvoke2) \
...
#define maIOCtl_maExtensionFunctionInvoke2 3
#define maIOCtl_maExtensionFunctionInvoke2_case(func) \
case 3: \
{ \
MAExtensionFunction _fn = (MAExtensionFunction)a; \
int _numargs = b; \
int _ptrs = c; \
return func(_fn, _numargs, _ptrs); \
} \

#define maIOCtl_maFontLoadDefault 4
...
#define maIOCtl_maFontSetCurrent 5
...
#define maIOCtl_maFontGetCount 6
...
#define maIOCtl_maFontGetName 7
...
#define maIOCtl_maFontLoadWithName 8
...
#define maIOCtl_maReportCallStack 10
...
#define maIOCtl_maDumpCallStackEx 11
...
#define maIOCtl_maProtectMemory 12
...
#define maIOCtl_maUnprotectMemory 13
...
#define maIOCtl_maSetMemoryProtection 14
...
#define maIOCtl_maGetMemoryProtection 15
...
#define maIOCtl_maGetBatteryCharge 16
...
#define maIOCtl_maLockKeypad 26
...
#define maIOCtl_maUnlockKeypad 27
...
#define maIOCtl_maKeypadIsLocked 28
...
#define maIOCtl_maBtStartDeviceDiscovery 30
...
#define maIOCtl_maBtGetNewDevice 31
...
#define maIOCtl_maBtStartServiceDiscovery 32
...
#define maIOCtl_maBtGetNextServiceSize 33
...
#define maIOCtl_maBtGetNewService 34
...
#define maIOCtl_maBtCancelDiscovery 35
...
#define maIOCtl_maLocationStart 38
...
#define maIOCtl_maLocationStop 39
...
#define maIOCtl_maPlatformRequest 40
...
#define maIOCtl_maFileExists 42
...
#define maIOCtl_maFileCreate 44
...
#define maIOCtl_maFileDelete 45
...
#define maIOCtl_maFileAvailableSpace 47
...
#define maIOCtl_maFileTotalSpace 48
...
#define maIOCtl_maFileRename 50
...
#define maIOCtl_maFileTruncate 51
...
#define maIOCtl_maFileWriteFromData 53
...
#define maIOCtl_maFileReadToData 55
...
#define maIOCtl_maFileListStart 58
...
#define maIOCtl_maFileListNext 59
...
#define maIOCtl_maFileListClose 60
...
#define maIOCtl_maFileSetProperty 61
...
#define maIOCtl_maSaveImageToDeviceGallery 62
...
#define maIOCtl_maSendTextSMS 63
...
#define maIOCtl_maFrameBufferGetInfo 81
...
#define maIOCtl_maFrameBufferInit 82
...
#define maIOCtl_maFrameBufferClose 83
...
#define maIOCtl_maSendToBackground 88
...
#define maIOCtl_maBringToForeground 89
...
#define maIOCtl_maGetSystemProperty 91
...
#define maIOCtl_maIapShutdown 94
...
#define maIOCtl_maNetworkStatus 95
...
#define maIOCtl_maIapSetMethod 96
...
#define maIOCtl_maIapSetFilter 97
...
#define maIOCtl_maCameraFormatNumber 144
...
#define maIOCtl_maCameraFormat 145
...
#define maIOCtl_maCameraStart 146
...
#define maIOCtl_maCameraStop 147
...
#define maIOCtl_maCameraSetPreview 148
...
#define maIOCtl_maCameraSelect 149
...
#define maIOCtl_maCameraNumber 150
...
#define maIOCtl_maCameraSnapshot 151
...
#define maIOCtl_maCameraSnapshotAsync 152
...
#define maIOCtl_maCameraRecord 153
...
#define maIOCtl_maCameraSetProperty 154
...
#define maIOCtl_maCameraGetProperty 155
...
#define maIOCtl_maCameraPreviewSize 156
...
#define maIOCtl_maCameraPreviewEventEnable 157
...
#define maIOCtl_maCameraPreviewEventDisable 158
...
#define maIOCtl_maCameraPreviewEventConsumed 159
...
#define maIOCtl_maShowVirtualKeyboard 160
...
#define maIOCtl_maKeyCaptureStart 162
...
#define maIOCtl_maKeyCaptureStop 163
...
#define maIOCtl_maHomeScreenEventsOn 164
...
#define maIOCtl_maHomeScreenEventsOff 165
...
#define maIOCtl_maHomeScreenShortcutAdd 166
...
#define maIOCtl_maHomeScreenShortcutRemove 167
...
#define maIOCtl_maNotificationAdd 168
...
const char* _text = GVS(ARG_NO_4); \
return func(_type, _id, _title, _text); \
} \

#define maIOCtl_maNotificationRemove 169
...
#define maIOCtl_maScreenSetFullscreen 170
...
#define maIOCtl_maAutostartOn 171
...
#define maIOCtl_maAutostartOff 172
...
#define maIOCtl_maScreenStateEventsOn 173
...
#define maIOCtl_maScreenStateEventsOff 174
...
#define maIOCtl_maReportResourceInformation 424
...
#define maIOCtl_maMessageBox 425
...
const char* _button2 = GVS(ARG_NO_4); \
const char* _button3 = GVS(ARG_NO_5); \
func(_title, _message, _button1, _button2, _button3); \
return 0; \
} \

#define maIOCtl_maToast 427
...
#define maIOCtl_maImagePickerOpen 428
...
#define maIOCtl_maImagePickerOpenWithEventReturnType 429
...
#define maIOCtl_maOptionsBox 430
...
const void* _otherButtonTitles = GVMR(ARG_NO_4, MAAddress); \
int _otherButtonTitlesSize = ARG_NO_5; \
func(_title, _destructiveButtonTitle, _cancelButtonTitle, _otherButtonTitles, _otherButtonTitlesSize); \
return 0; \
} \

#define maIOCtl_maSensorStart 431
...
#define maIOCtl_maSensorStop 432
...
#define maIOCtl_maNFCReadTag 435
...
#define maIOCtl_maNFCDestroyTag 436
...
#define maIOCtl_maNFCConnectTag 437
...
#define maIOCtl_maNFCCloseTag 438
...
#define maIOCtl_maNFCIsType 439
...
#define maIOCtl_maNFCGetTypedTag 440
...
#define maIOCtl_maNFCBatchStart 441
...
#define maIOCtl_maNFCBatchCommit 442
...
#define maIOCtl_maNFCBatchRollback 443
...
#define maIOCtl_maNFCTransceive 444
...
const void* _src = GVMR(b, MAAddress); \
int _srcLen = c; \
void* _dst = GVMR(ARG_NO_4, MAAddress); \
int* _dstLen = GVMR(ARG_NO_5, int); \
return func(_tag, _src, _srcLen, _dst, _dstLen); \
} \

#define maIOCtl_maNFCSetReadOnly 445
...
#define maIOCtl_maNFCIsReadOnly 446
...
#define maIOCtl_maNFCGetSize 447
...
#define maIOCtl_maNFCReadNDEFMessage 449
...
#define maIOCtl_maNFCWriteNDEFMessage 450
...
#define maIOCtl_maNFCCreateNDEFMessage 451
...
#define maIOCtl_maNFCGetNDEFMessage 452
...
#define maIOCtl_maNFCGetNDEFRecord 453
...
#define maIOCtl_maNFCGetNDEFRecordCount 454
...
#define maIOCtl_maNFCGetNDEFId 455
...
#define maIOCtl_maNFCGetNDEFPayload 456
...
#define maIOCtl_maNFCGetNDEFTnf 457
...
#define maIOCtl_maNFCGetNDEFType 458
...
#define maIOCtl_maNFCSetNDEFId 459
...
#define maIOCtl_maNFCSetNDEFPayload 460
...
#define maIOCtl_maNFCSetNDEFTnf 461
...
#define maIOCtl_maNFCSetNDEFType 462
...
#define maIOCtl_maNFCAuthenticateMifareSector 463
...
int _keyType = b; \
int _sectorIndex = c; \
const void* _keySrc = GVMR(ARG_NO_4, MAAddress); \
int _keyLen = ARG_NO_5; \
return func(_tagHandle, _keyType, _sectorIndex, _keySrc, _keyLen); \
} \

#define maIOCtl_maNFCGetMifareSectorCount 464
...
#define maIOCtl_maNFCGetMifareBlockCountInSector 465
...
#define maIOCtl_maNFCMifareSectorToBlock 466
...
#define maIOCtl_maNFCReadMifareBlocks 467
...
#define maIOCtl_maNFCWriteMifareBlocks 468
...
#define maIOCtl_maNFCReadMifarePages 469
...
#define maIOCtl_maNFCWriteMifarePages 470
...
#define maIOCtl_maDBExecSQL 473
...
#define maIOCtl_maDBExecSQLParams 474
...
int _paramCount = ARG_NO_4; \
return func(_databaseHandle, _sql, _params, _paramCount); \
} \

#define maIOCtl_maDBCursorDestroy 475
...
#define maIOCtl_maDBCursorNext 476
...
#define maIOCtl_maDBCursorGetColumnData 477
...
#define maIOCtl_maDBCursorGetColumnText 478
...
int _bufferSize = ARG_NO_4; \
return func(_cursorHandle, _columnIndex, _buffer, _bufferSize); \
} \

#define maIOCtl_maDBCursorGetColumnInt 479
...
#define maIOCtl_maDBCursorGetColumnDouble 480
...
#define maIOCtl_maAudioDataCreateFromResource 481
...
MAHandle _data = (MAHandle)b; \
int _offset = c; \
int _length = ARG_NO_4; \
int _flags = ARG_NO_5; \
return func(_mime, _data, _offset, _length, _flags); \
} \

#define maIOCtl_maAudioDataCreateFromURL 482
...
#define maIOCtl_maAudioDataDestroy 483
...
#define maIOCtl_maAudioInstanceCreate 484
...
#define maIOCtl_maAudioInstanceCreateDynamic 485
...
#define maIOCtl_maAudioSubmitBuffer 486
...
#define maIOCtl_maAudioGetPendingBufferCount 487
...
#define maIOCtl_maAudioInstanceDestroy 488
...
#define maIOCtl_maAudioGetLength 489
...
#define maIOCtl_maAudioSetNumberOfLoops 490
...
#define maIOCtl_maAudioPrepare 491
...
#define maIOCtl_maAudioPlay 492
...
#define maIOCtl_maAudioSetPosition 493
...
#define maIOCtl_maAudioGetPosition 494
...
#define maIOCtl_maAudioSetVolume 495
...
#define maIOCtl_maAudioPause 496
...
#define maIOCtl_maAudioStop 497
...
#define maIOCtl_maSyscallPanicsEnable 498
...
#define maIOCtl_maSyscallPanicsDisable 499
...
#define maIOCtl_maAdsBannerCreate 500
...
#define maIOCtl_maAdsBannerDestroy 501
...
#define maIOCtl_maAdsAddBannerToLayout 502
...
#define maIOCtl_maAdsRemoveBannerFromLayout 503
...
#define maIOCtl_maAdsBannerSetProperty 504
...
#define maIOCtl_maNotificationLocalDestroy 507
...
#define maIOCtl_maNotificationLocalSetProperty 508
...
#define maIOCtl_maNotificationLocalGetProperty 509
...
#define maIOCtl_maNotificationLocalSchedule 510
...
#define maIOCtl_maNotificationLocalUnschedule 511
...
#define maIOCtl_maNotificationPushRegister 512
...
#define maIOCtl_maNotificationPushUnregister 513
...
#define maIOCtl_maNotificationPushGetRegistration 514
...
#define maIOCtl_maNotificationPushGetData 515
...
#define maIOCtl_maNotificationPushDestroy 516
...
#define maIOCtl_maNotificationSetIconBadge 517
...
#define maIOCtl_maNotificationGetIconBadge 518
...
#define maIOCtl_maNotificationPushSetTickerText 519
...
#define maIOCtl_maNotificationPushSetMessageTitle 520
...
#define maIOCtl_maNotificationPushSetDisplayFlag 521
...
#define maIOCtl_maCaptureSetProperty 522
...
#define maIOCtl_maCaptureGetProperty 523
...
#define maIOCtl_maCaptureAction 524
...
#define maIOCtl_maCaptureWriteImage 525
...
#define maIOCtl_maCaptureGetImagePath 526
...
#define maIOCtl_maCaptureGetVideoPath 527
...
#define maIOCtl_maCaptureDestroyData 528
...
#define maIOCtl_maPurchaseSupported 529
...
#define maIOCtl_maPurchaseCreate 530
...
#define maIOCtl_maPurchaseSetPublicKey 531
...
#define maIOCtl_maPurchaseRequest 532
...
#define maIOCtl_maPurchaseVerifyReceipt 533
...
#define maIOCtl_maPurchaseGetField 534
...
#define maIOCtl_maPurchaseSetStoreURL 535
...
#define maIOCtl_maPurchaseGetName 536
...
#define maIOCtl_maPurchaseRestoreTransactions 537
...
#define maIOCtl_maPurchaseDestroy 538
...
#define maIOCtl_maScreenSetOrientation 539
...
#define maIOCtl_maScreenSetSupportedOrientations 540
...
#define maIOCtl_maScreenGetSupportedOrientations 541
...
#define maIOCtl_maScreenGetCurrentOrientation 542
